...
@section('content')
    ...
    <!-- Page header -->
    @component('admin.categories.components.page-header', [ 'title' => 'Edit Service Category' ])
    @endcomponent
    <!-- /page header -->
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="first_name" class="control-label col-sm-3 text-right">Category Name</label>
                    <div class="col-sm-5">
                ...
                <!-- Category Slug -->
                <div class="form-group">
                    <label for="last_name" class="control-label col-sm-3 text-right">Category slug</label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        {!! Form::textarea('description', null, [ 'class' => 'form-control', 'cols' => null, 'rows' => null ]) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-5 col-sm-offset-3">
                        <img src="{{ $category->getImage() }}" alt="" class="img-thumbnail">
                    </div>
                </div>

                <!-- Category Image -->
                <div class="form-group">
                    <label for="image" class="control-label col-sm-3 text-right">Category Image</label>
                    <div class="col-sm-5">
