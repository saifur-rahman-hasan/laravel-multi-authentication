        ...
        <div class="tabbable panel login-form width-400">
            ...
            <div class="tab-content panel-body">
                <div class="tab-pane fade in active" id="basic-tab1">
                    <form method="POST" action="{{ route('login', [ 'userType' => 'serviceProvider' ]) }}">
                        @csrf
                        ...
                        <div class="form-group has-feedback has-feedback-left">
                            <input v-model="loginCredentials.email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="{{ __('E-Mail Address') }}" required autofocus>
                        ...
                        <div class="form-group has-feedback has-feedback-left">
                            <input v-model="loginCredentials.password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="{{ __('Password') }}" required>
                            <div class="form-control-feedback">
                ...
                <div class="tab-pane fade" id="basic-tab2">
                    <form method="POST" action="{{ route('register', [ 'userType' => 'serviceProvider' ]) }}">
                        @csrf
...
@push('scripts')
    <script src="{{ asset('js/website/auth/login.js') }}"></script>
    @endpush